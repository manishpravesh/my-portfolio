  ...
  return (
    <div className="bg-custom-yellow border-y-4 border-black py-3 overflow-hidden whitespace-nowrap relative rotate-[-2deg] scale-105 z-20 my-10">
      <div className="animate-marquee inline-block font-shrikhand text-2xl">
        ...
        <span className="mx-4">SOFTWARE DEVELOPER 💻</span>
        <span className="mx-4">NODE • POSTGRESQL • REDIS • SYSTEM DESIGN ⚡</span>
        <span className="mx-4">BUILDING SCALABLE APIS 🛠️</span>
        <span className="mx-4">AVAILABLE FOR INTERNSHIPS & SDE ROLES 💼</span>
